...
namespace Ahmadifar\Models;

use Ahmadifar\Interfaces\BaseModelInterface;
use Ahmadifar\Interfaces\FiltersInterface;
use Illuminate\Support\Facades\DB;
use Ahmadifar\Traits\HasIdTrait;
use Ahmadifar\Traits\MagicMethodsTrait;
